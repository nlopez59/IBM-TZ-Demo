...
# Prepare Phase:     
    ...
    ## This script appends the extension '.dbrm' to that file.  The WD generate step uses extensions as a 'type' property to  
    ## assign a building block actions/steps like DB2 Bind or CICS newcopy.   
    ## Ref: https://www.ibm.com/docs/en/developer-for-zos/17.0?topic=deployment-static-python-translator
    

    prepare=$adminScripts/dbb_prepare_local_folder.py
